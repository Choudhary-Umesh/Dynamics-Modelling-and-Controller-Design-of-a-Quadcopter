%% QUADCOPTER PITCH PLANT SIMULATION TRAJECTORY GENERATOR (Figure 2.33)
...
%% 2. Define Pitch Imbalance Inputs (Front vs Rear pairing)
% Front motors lower, Rear motors higher -> Creates a pitch tilt along X-axis
Omega1_val = 599.99;  % Right Front
Omega2_val = 599.99;  % Left Front
Omega3_val = 600.01;  % Left Rear
Omega4_val = 600.01;  % Right Rear

%% 3. Run the Simulink Model (Modern Explicit Workspace Mapping)
fprintf('Simulating pitch profile...\n');
...
%% 5. Render Figure 2.33 Graph
figure('Name', 'Figure 2.33 - Pitch plant simulation', 'Color', 'w');

% Plot Center of Mass pitch displacement path
...
subtitle('Figure 2.33-Pitch plant simulation');
view(3);