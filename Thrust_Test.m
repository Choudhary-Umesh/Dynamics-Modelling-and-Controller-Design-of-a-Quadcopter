%% QUADCOPTER PURE THRUST TRAJECTORY GENERATOR (Figure 2.31)
...
%% 2. Define Balanced Hover/Climb Inputs 
Omega1_val = 600;
Omega2_val = 600;
Omega3_val = 600;
Omega4_val = 600;
...
fprintf('Simulating thrust profile...\n');
...
%% 5. Transform Local Arms to Global 3D Paths
for i = 1:num_steps
    ...
    % Hardcoded pi/4 directly to guarantee zero variable mapping errors
...
%% 6. Render Figure 2.31 Graph
figure('Name', 'Figure 2.31 - Thrust plant simulation', 'Color', 'w');
...
subtitle('Figure 2.31-Thrust plant simulation');
